...
public final class KernelCommunicator {
  private var afterSuccessfulExecutionHandlers: [() -> [JupyterDisplayMessage]]
  private var parentMessageHandlers: [(ParentMessage) -> Void]
  ...
  public func afterSuccessfulExecution(
  ...
  public func handleParentMessage(_ handler: @escaping (ParentMessage) -> Void) {
  ...
  public func triggerAfterSuccessfulExecution() -> [[(address: UInt, count: Int)]] {
  ...
  public func updateParentMessage(to parentMessage: ParentMessage) {
